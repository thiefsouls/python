...
conector = mysql.connector.connect(
    host='',#add seu host do banco de dados.
    user='', #add seu user do banco de dados.
    passwd='', #add seu passwd do banco de dados.
    database="")#add seu database do banco de dados.
